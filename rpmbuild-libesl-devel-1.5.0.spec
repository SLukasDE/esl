...
mkdir -p $RPM_BUILD_ROOT/usr/include/esl-1.5.0
cd ../../src/main
find . -name '*.h' -exec cp --parents {} $RPM_BUILD_ROOT/usr/include/esl-1.5.0 \;
cd ../../rpm/BUILD
ln -s esl-1.5.0/esl $RPM_BUILD_ROOT/usr/include/esl
rm -rf $RPM_BUILD_ROOT/usr/include/esl-1.5.0/esl/caching
rm -rf $RPM_BUILD_ROOT/usr/include/esl-1.5.0/esl/com/mqtt
rm -rf $RPM_BUILD_ROOT/usr/include/esl-1.5.0/esl/com/smtp
rm -rf $RPM_BUILD_ROOT/usr/include/esl-1.5.0/esl/compression
rm -rf $RPM_BUILD_ROOT/usr/include/esl-1.5.0/esl/crypto

exit

%files
%defattr(644, root, root, 755)
/usr/include/esl-1.5.0
/usr/include/esl
