...
template<class Object>
esl::monitoring::Logger<> ObjectPool<Object>::logger("esl::utility::ObjectPool<>");

template<class Object>
esl::monitoring::Logger<> ObjectPool<Object>::Deleter::logger("esl::utility::ObjectPool<>::Deleter");
